...
const  Card = (data) => {
    ...
    const addProductToCard=(event,productData)=>{
        ...
        context.setCartsProducts([...context.cartProducts, productData ])
    ...
    return(
        ...
        onClick={()=>showProduct(data.data)}>
            <figure className="relative mb-2 w-full h-4/5">
                ...
                <img className="w-full h-full object-cover rounded-lg" src= {data.data.images[0]} alt="headphones"></img>
